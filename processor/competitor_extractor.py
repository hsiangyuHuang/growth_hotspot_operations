...
def extract(items: list[dict], run_date: str) -> dict:
    ...
    md = _build_items_markdown(items)
    logger.info(f"[CompetitorExtractor] Input: {len(items)} items, {len(md)} chars markdown")
